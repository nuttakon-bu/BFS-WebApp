...
$report_arrival_list = get_report_flight_aircraft('Arrival');
$report_departure_list = get_report_flight_aircraft('Departure');
?>

<div class="card" method="GET" action="index.php">
    <div class="card-header">
        <h1>Flight Information by Aircraft Type</h1>
    </div>
    <div class="card-body">
